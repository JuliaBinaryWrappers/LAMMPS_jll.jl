# Autogenerated wrapper script for LAMMPS_jll for aarch64-apple-darwin-mpi+none
...
function __init__()
    JLLWrappers.@generate_init_header(CompilerSupportLibraries_jll, LLVMOpenMP_jll, libblastrampoline_jll, FFTW_jll)
