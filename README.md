...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/6bf67eacf20dc96e162a2493e93fc19e6008c459/L/LAMMPS/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* `Linux x86_64 {cuda=12.6, cxxstring_abi=cxx11, libc=glibc, mpi=mpitrampoline}` (`x86_64-linux-gnu-cxx11-cuda+12.6-mpi+mpitrampoline`)
